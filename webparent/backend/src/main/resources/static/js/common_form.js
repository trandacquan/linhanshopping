...
function showImageThumbnail(fileInput) {
	...
	reader.onload = function (e) {
        ...
        //gán giá trị của e.target.result vào thuộc tính src -->đây là cách thay đổi hình khi chọn file hình mới
	};
...
function checkFileSize(fileInput) {
    ...
    if (fileSize > MAX_FILE_SIZE) {
        ...
        //hiện lỗi bên cạnh button choose file khi chọn file hình vượt quá kích thước cho phép
